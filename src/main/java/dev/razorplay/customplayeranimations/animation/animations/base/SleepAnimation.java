...
import static dev.razorplay.customplayeranimations.animation.AnimationProvider.SLEEPING_ANIMATION;
    ...
    public static void playAnimation(AnimationContext context) {
        if (context.player().isSleeping()) {
            if (!CONFIG.sleepingAnimationsConfig.isEnabled()) {
                ...
                context.mainAnimationContainer().setCurrentAnimation(SLEEPING_ANIMATION.animation());
                context.mainAnimationContainer().setCurrentAnimationId(SLEEPING_ANIMATION.animationId());
            }
        }
    }
}
