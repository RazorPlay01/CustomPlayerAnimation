...
public class TridentAnimation implements ICustomAnimation {
    ...
    public boolean shouldPlayAnimation(AnimationContext context) {
        return context.avatar().isUsingItem() && context.avatar().getUseItem().getItem() instanceof TridentItem;
    }
    ...
    private static void setTridentAnimation(AnimationContext context, boolean isRightHand, int yawOffset) {
        ...
        context.avatar().setYBodyRot(context.playerData().getPlayerHeadYaw() + yawOffset);
