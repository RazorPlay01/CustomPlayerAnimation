    ...
    public void playAnimation(AnimationContext context) {
        ...
        if (!CONFIG.getOverlayAnimations().toolsAnimations.pickaxeAnimationsConfig.isEnabled()) {
            ...
            if (context.avatar().swinging &&
                    isPickaxe(context.avatar().getMainHandItem()) &&
                    context.avatar().getMainHandItem().getItem().getDefaultInstance().getComponents().has(DataComponents.TOOL) &&
                ...
                context.overlayAnimationContainer().setCurrentAnimation(context.avatar().isCrouching() ? getAnimation(AnimationsId.PICKAXE_SNEAK_ANIMATION.getAnimationId()) : getAnimation(AnimationsId.PICKAXE_ANIMATION.getAnimationId()));
                context.overlayAnimationContainer().setCurrentAnimationId(context.avatar().isCrouching() ? AnimationsId.PICKAXE_SNEAK_ANIMATION.getAnimationId() : AnimationsId.PICKAXE_ANIMATION.getAnimationId());
